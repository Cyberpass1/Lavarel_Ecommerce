          ...
          <div class="register-form">
            <form method="POST" action="{{ route('register') }}" name="register-form" class="needs-validation" novalidate="">
              ...
              <div class="d-flex align-items-center mb-3 pb-2">
                <p class="m-0">Tus datos personales serán utilizados para mejorar tu experiencia en este sitio web, gestionar el acceso a tu cuenta y para otros fines descritos en nuestra política de privacidad.</p>
              </div>

              <button class="btn btn-primary w-100 text-uppercase" type="submit">Registro</button>

              <div class="customer-option mt-4 text-center">
                <span class="text-secondary">¿Ya tienes una cuenta?</span>
                <a href="{{route('login')}}" class="btn-text js-show-register">Inicia sesión</a>
              </div>
            </form>
          </div>
        </div>
