  ...
  <main class="pt-90">
    <section class="shop-main container d-flex pt-4 pt-xl-5">
            ...
            <div id="accordion-filter-1" class="accordion-collapse collapse show border-0"
              ...
              <div class="accordion-body px-0 pb-0 pt-3">
                <ul class="list list-inline mb-0">
                  <li class="list-item">
                    <a href="#" class="menu-link py-1">Vestidos</a>
                  </li>
                  <li class="list-item">
                    <a href="#" class="menu-link py-1">Shorts</a>
                  </li>
                  <li class="list-item">
                    <a href="#" class="menu-link py-1">Sudaderas</a>
                  </li>
                  <li class="list-item">
                    <a href="#" class="menu-link py-1">Traje de baños</a>
                  </li>
                  <li class="list-item">
                    <a href="#" class="menu-link py-1">Chaquetas</a>
                  </li>
                  <li class="list-item">
                    <a href="#" class="menu-link py-1">Franelas y tops</a>
                  </li>
                  <li class="list-item">
                  ...
                  <li class="list-item">
                    <a href="#" class="menu-link py-1">Hombres</a>
                  </li>
                  <li class="list-item">
          ...
          <div class="accordion-item mb-4">
            ...
            <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
              ...
              <div class="price-range__info d-flex align-items-center mt-2">
                <div class="me-auto">
                  <span class="text-secondary">Precio minimo: </span>
                  <span class="price-range__min">$250</span>
                </div>
                <div>
                  <span class="text-secondary">Precio máximo: </span>
                ...
                <div class="slide-split_text position-relative d-flex align-items-center"
                  ...
                  <div class="slideshow-text container p-3 p-xl-5">
                    <h2
                      ...
                      Accesorios  <br /><strong>Mujeres</strong></h2>
      ...
      <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Sort Items"
              name="total-number" style="margin-right: 20px;">>
        ...
        @else
          <form name="addtocart-form" method="post" action="{{ route('cart.add') }}">
            @csrf
              ...
              <button  type="submit" class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium " data-aside="cartDrawer" title="Add To Cart">Añadir al carro</button>
            </form>
                  @endif
                </div>
