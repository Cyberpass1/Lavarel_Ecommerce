        ...
        <div class="col-lg-5">
          <div class="d-flex justify-content-between mb-4 pb-md-2">
            ...
            <div
              ...
              <a href="#" class="text-uppercase fw-medium"><span class="menu-link menu-link_us-s">Siguiente</span><svg
        ...
        @else
          ...
          <form name="addtocart-form" method="post" action="{{ route('cart.add') }}">
            ...
            <div class="product-single__addtocart">
              ...
              <button type="submit" class="btn btn-primary btn-addtocart " data-aside="cartDrawer">Añadir al carro</button>
            </div>
          </form>
          @endif
          <div class="product-single__addtolinks">
            <a href="#" class="menu-link menu-link_us-s add-to-wishlist"><svg width="16" height="16" viewBox="0 0 20 20"
                ...
                <use href="#icon_heart" />
              </svg><span>Añadir a la lista de deseo</span></a>
            ...
            <div class="product-single__review-form">
              <form name="customer-review-form">
                ...
                <div class="form-label-fixed mb-4">
                  <label for="form-input-name" class="form-label">Nombre *</label>
        ...
        @else
          <form name="addtocart-form" method="post" action="{{ route('cart.add') }}">
            @csrf
              ...
              <input type="hidden" name="price" value="{{$product->sale_price == '' ? $rproduct->regular_price:$rproduct->sale_price}}"/>
