...
<body class="body">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="add-product.html" class="">
                                                <div class="text">Añadir producto</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="sub-menu-item">
                                            <a href="order-tracking.html" class="">
                                                <div class="text">Seguimiento de orden</div>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                            ...
                            <div class="header-left">
                                ...
                                <form class="form-search flex-grow">
                                    ...
                                    <div class="box-content-search" id="box-content-search">
                                        ...
                                        <ul class="">
                                            <li class="mb-14">
                                                <div class="body-title">Orden de producto</div>
                                            </li>
                                            <li class="mb-14">
                                                <div class="divider"></div>
                                            </li>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content"
                                            ...
                                            <li>
                                                <div class="message-item item-1">
                                                    ...
                                                    <div>
                                                        <div class="body-title-2">Discuentos disponbles</div>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content"
                                            ...
                                            <li>
                                                <a href="#" class="user-item">
                                                    ...
                                                    <div class="body-title-2">Cuenta</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" class="user-item">
                                                    ...
                                                    <div class="body-title-2">Bandeja</div>
                                            ...
                                            <li>
                                                <a href="#" class="user-item">
                                                    ...
                                                    <div class="body-title-2">Barra de tareas</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" class="user-item">
                                                    ...
                                                    <div class="body-title-2">Soporte</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="login.html" class="user-item">
                                                    ...
                                                    <div class="body-title-2">Salir</div>
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
   ...
   <div class="bottom-page">
      <div class="body-text">Copyright © 2025 Cyberiajc</div>
   </div>
</div>
